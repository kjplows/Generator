...
int main(int argc, char ** argv)
{
  ...
  for( ; evgliter != evglist->end() ; ++evgliter ) {
    ...
    */
    ...
    /* I should do something about legacy adaptive integration...
    ...
    */
	...
	new GridQELdXSec( alg, interaction );
      ...
      */
      ...
      // Refactoring the calls to BindHitNucleon() to make a mask
      // Store the result in a TH2C (1 char per cell), 0 or 1
	...
	if( iy != iy_prev ) {
	  ...
	  LOG("gqelmap", pNOTICE) << "Evaluated iy = " << iy
				  << " in " 
